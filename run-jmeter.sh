...
Host / Port / Protocol
    ...
    -JHost=<hostname> (Default: confluence)     - Hostname for all requests
    -JPort=<Port> (Default: 8090)               - Port for all requests
    -JProtocol=<Protocol> (Default: http)       - Protocol for all requests
